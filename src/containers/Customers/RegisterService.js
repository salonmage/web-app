          ...
          <Table hover responsive className="table-outline">
            ...
            <tbody>
              <tr>
                ...
                <td>Đã thanh toán</td>
                <td>
                  <i style={{ cursor: "pointer" }} className="fa fa-remove" />
                </td>
              </tr>
            </tbody>
          </Table>
          <Row form>
            <Col>
              <div className="alert alert-secondary">
                <FormGroup row>
                  <Label className="text-info customLabel">{t("Tổng")}</Label>
                  ...
                  <Label className="text-info customLabel">{t("Đã trả")}</Label>
        ...
        <Col md="8">
          <div className="alert alert-secondary">
            ...
            <FormGroup row className="sbtGroup">
              <Label className="text-info customLabel">{t("Số lượng")}</Label>
              <Col md="2">
                <Input type="text" />
              </Col>
      ...
      <Row form>
        ...
        <Col md="8">
          <div className="alert alert-secondary">
            ...
            <FormGroup row className="sbtGroup">
              <Label className="text-info customLabel">{t("Số lần")}</Label>
              <Col md="2">
                <Input type="text" />
              </Col>
              <Label className="text-info customLabel">{t("Giảm giá")}</Label>
